...
transaction_type_distribution = {
    ...
    'CASH_OUT': 0.1,
    'WALLET_TO_BANK': 0.05,
    'BANK_PARKING_TO_BANK_TRANSFER': 0.01,
    'BRANCH_TO_MERCHANT': 0.01,
    'MERCHANT_TO_BRANCH': 0.01,
    'MERCHANT_TO_BANK_TRANSFER': 0.01,
    'MERCHANT_GATEWAY_TRANSACTION': 0.01,
    'AGENT_ADD_FUND': 0.01,
    'AGENT_FLOAT_COLLECTION': 0.01,
    'SUBSIDY_RESERVE_PAYMENT': 0.01,
    'SUBSIDY_RELEASE_PAYMENT': 0.01,
    'SUBSIDY_CASHBACK_PAYMENT': 0.01,
    'SUBSIDY_DIRECT_DISBURSEMENT': 0.01,
    'CHARITY_PAYMENT': 0.01,
    'HELPING_HAND_CREATION_FEE': 0.01,
    'COMMISSION_PAYMENT': 0.01,
    'INCENTIVE_PAYMENT': 0.01,
    'CHARITY_BALANCE_TRANSFER': 0.01
}
